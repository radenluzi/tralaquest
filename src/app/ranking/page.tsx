  ...
  return (
    <div className="space-y-4">
      <SectionCard className="p-5">
        ...
        <h2 className="mt-1 text-2xl font-bold">Top active users.</h2>
        <p className="mt-2 text-sm text-zinc-300">Ranking data is loaded live from Supabase.</p>
      </SectionCard>
      <SectionCard>
            ...
            <div key={leader.id} className="flex items-center justify-between rounded-2xl bg-white/5 px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">streak {leader.streak} days</p>
                </div>
              </div>
              <p className="text-sm text-zinc-300">{leader.total_points} pts</p>
            </div>
          ))}
        </div>
      </SectionCard>
